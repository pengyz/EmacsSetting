...
(ecb-layout-define "my-left-speedbar" left nil
  (ecb-split-ver 0.2826086956521739 t)
  ...
  (ecb-split-ver 0.5757575757575758 t)
  (dotimes (i 1) (other-window -1) (if (equal (selected-window) ecb-compile-window) (other-window -1)))
  (dotimes (i 1) (other-window 1) (if (equal (selected-window) ecb-compile-window) (other-window 1)))
...
(ecb-layout-define "my-left-analyse" left nil
  (ecb-split-ver 0.4 t)
  (if (fboundp (quote ecb-set-methods-buffer)) (ecb-set-methods-buffer) (ecb-set-default-ecb-buffer))
  (dotimes (i 1) (other-window 1) (if (equal (selected-window) ecb-compile-window) (other-window 1)))
  (ecb-split-ver 0.5 t)
